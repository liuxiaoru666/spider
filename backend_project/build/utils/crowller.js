...
var superagent_1 = __importDefault(require("superagent")); //html内容获取
var Crowller = /** @class */ (function () {
    //
    function Crowller(url, analyzer) {
        this.url = url;
        this.analyzer = analyzer;
        this.filePath = path_1.default.resolve(__dirname, '../../data/jianshu.json');
        this.initSpider();
    }
    //获取html
    ...
    Crowller.prototype.writeFilte = function (content) {
